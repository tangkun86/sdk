...
class CController extends Controller
{
    ...
    protected function _initialize() {
        ...
        C('TMPL_ACTION_ERROR',CONTROLLER_NAME.':'.ACTION_NAME);
        if(!isset($_SESSION['dev'])){
            if(CONTROLLER_NAME=='Users' && (ACTION_NAME=='loginDev' || ACTION_NAME=='register')){
                return true;
            }else{
                $this->redirect('Users/loginDev');
            }
        }else{
            $_SESSION['user_id'] = $_SESSION['dev']['id'];
            $_SESSION['username'] = $_SESSION['dev']['username'];
            $this->assign('user',$_SESSION['dev']);
        }
